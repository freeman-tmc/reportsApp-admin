...
class ReportForm extends Component {
        ...
        switch (event.target.name) {
            ...
            case 'phase':
                this.setState({
                    ...
                    disableSubmit: this.state.dateInput && event.target.value && this.state.statusInput && this.state.noteInput && !this.state.dateError
                })
                break;
            ...
            case 'status':
                this.setState({
                    ...
                    disableSubmit: this.state.dateInput && this.state.phaseInput && event.target.value && this.state.noteInput && !this.state.dateError
                })
                break;
            ...
            case 'note':
                this.setState({
                    ...
                    disableSubmit: this.state.dateInput && this.state.phaseInput && this.state.statusInput && event.target.value && !this.state.dateError
                })
                break;
    ...
    render() {
        ...
        return (
            <div>
                {this.props.error ? <h1 className="error-info">Server error!</h1> :
                    <React.Fragment>
                        <div className="list">
